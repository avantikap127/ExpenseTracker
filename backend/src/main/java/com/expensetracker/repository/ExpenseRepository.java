...
public interface ExpenseRepository extends JpaRepository<Expense, Long> {
    ...
    List<Expense> findByUserAndCategory_CategoryId(User user, Long categoryId); // Basically categoryById is a derived query(method) and it does not exist in jpa repository so we are creating this. We are declaring the method in the repository interface.Spring automatically generates its implementation at runtime.
